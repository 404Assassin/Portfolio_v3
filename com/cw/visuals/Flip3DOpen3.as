package com.cw.visuals{
	...
	public class Flip3DOpen3 extends MovieClip{
		//[=-------------------------------------------------
		// Public Variables
		//[=-------------------------------------------------
		...
		public function Flip3DOpen3(placementTarget){
			trace('Flip3DOpen3 this placementTarget?'+ placementTarget);
		...
		public function addToDisplay(the_mcX, the_mcY){
			...
			TweenMax.to (the_Center_placement0, 0, {alpha:.0, x:0, y:0, z:-3000, ease:Sine.easeOut});
