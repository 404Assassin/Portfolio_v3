package com.cw.visuals.flipOpen3D{
	/**
	 * :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	 * Class discription: public class CFlipOpen3Dv2 implements ICFlip3D
	...
	// Class
	//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	public class CFlipOpen3Dv2/* implements ICFlip3D*/{
		//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
		// Private Variables
		//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
		...
		private function initStagePlacement(){
		...
		private function addOpenItem1(){
			TweenMax.to (placementArray[1], .25, {alpha:finalPlacementAlpha, rotationX:0, ease:Sine.easeInOut, onComplete:addOpenItem1_2});
		}
		private function addOpenItem2(){
			TweenMax.to (placementArray[5], .5, {alpha:finalPlacementAlpha, rotationY:0, ease:Sine.easeInOut, onComplete:addOpenItem2_2});
		}
		private function addOpenItem3(){
			TweenMax.to (placementArray[7], .75, {alpha:finalPlacementAlpha, rotationX:0, ease:Sine.easeInOut, onComplete:addOpenItem2_3});
		}
		private function addOpenItem4(){
			TweenMax.to (placementArray[3], 1, {alpha:finalPlacementAlpha, rotationY:0, ease:Sine.easeInOut, onComplete:addOpenItem2_4}); 
		}
		//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
		// part two animations
		//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
		private function addOpenItem1_2(){
			TweenMax.to (placementArray[2], .25, {alpha:finalPlacementAlpha, rotationY:0, ease:Sine.easeInOut, onComplete:addOpenItem2});
		}
		private function addOpenItem2_2(){
			TweenMax.to (placementArray[8], .5, {alpha:finalPlacementAlpha, rotationX:0, ease:Sine.easeInOut, onComplete:addOpenItem3});
		}
		private function addOpenItem2_3(){
			TweenMax.to (placementArray[6], .75, {alpha:finalPlacementAlpha, rotationY:0, ease:Sine.easeInOut, onComplete:addOpenItem4});
		}
		private function addOpenItem2_4(){
			TweenMax.to (placementArray[0], 1.5, {alpha:finalPlacementAlpha, rotationX:0, ease:Sine.easeOut});
		}
	}
}