package com.cw.visuals.flipOpen3D{
	/**
	 * :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	 * Class discription: public class CFlipOpen3Dv1 implements ICFlip3D
	...
	// Class
	//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	public class CFlipOpen3Dv1 implements ICFlip3D{
		//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
		// Private Variables
		//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
		...
		private function iterativeBuild():void {
			...
			for(var i:uint = 0; i < 9; i++){
				...
				//var theImage:Bitmap = LoaderMaxVars.getContent(imagesRefIteration).rawContent.bitmapData;
		...
		private function addOpenItem1(){
			TweenMax.to (placementArray[1], .5, {alpha:finalPlacementAlpha, rotationX:0, ease:Sine.easeInOut, onComplete:addOpenItem1_2, onComplete:reset3DTransformed, onCompleteParams:[placementArray[1]]});
		}
		private function addOpenItem2(){
			TweenMax.to (placementArray[5], .7, {alpha:finalPlacementAlpha, rotationY:0, ease:Sine.easeInOut, onComplete:addOpenItem2_2, onComplete:reset3DTransformed, onCompleteParams:[placementArray[5]]});
		}
		private function addOpenItem3(){
			TweenMax.to (placementArray[7], .9, {alpha:finalPlacementAlpha, rotationX:0, ease:Sine.easeInOut, onComplete:addOpenItem2_3, onComplete:reset3DTransformed, onCompleteParams:[placementArray[7]]});
		}
		private function addOpenItem4(){
			TweenMax.to (placementArray[3], 1.1, {alpha:finalPlacementAlpha, rotationY:0, ease:Sine.easeInOut, onComplete:addOpenItem2_4, onComplete:reset3DTransformed, onCompleteParams:[placementArray[3]]});
		}
		//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
		// part two animations
		//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
		private function addOpenItem1_2(currentItem:Sprite){
			TweenMax.to (placementArray[2], 1, {alpha:finalPlacementAlpha, rotationY:0, ease:Sine.easeOut, onComplete:reset3DTransformed, onCompleteParams:[placementArray[2]]});
		}
		private function addOpenItem2_2(currentItem:Sprite){
			TweenMax.to (placementArray[8], 1.1, {alpha:finalPlacementAlpha, rotationX:0, ease:Sine.easeOut, onComplete:reset3DTransformed, onCompleteParams:[placementArray[8]]});
		}
		private function addOpenItem2_3(currentItem:Sprite){
			TweenMax.to (placementArray[6], 1.2, {alpha:finalPlacementAlpha, rotationY:0, ease:Sine.easeOut, onComplete:reset3DTransformed, onCompleteParams:[placementArray[6]]});
		}
		private function addOpenItem2_4(currentItem:Sprite){
			TweenMax.to (placementArray[0], 1.4, {alpha:finalPlacementAlpha, rotationX:0, ease:Sine.easeOut, onComplete:reset3DTransformed, onCompleteParams:[placementArray[0]]});
		}
		//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
