package com.cw.controls.prompt{
	/**
	 * :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	 * Class discription: Error Pop-Up to be used with composition.
	...
	// Class
	//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	public class CErrorPopUp/* implements IErrorPopUp, IInvokedObserver*/{
		//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
		// Protected Variables
		//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
/*		public function observableInstanceRef(dynamicButtonObserver:InvokedObserver):void{
		 ...
		 * ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
		 */
		public function errorPopUpInterface(textContent:String):void{
...
/*		public function update(theObserver:InvokedObserver, infoObject:Object):void{
		...
		private function addToDisplay():void{
			...
			placementTarget.addChild(contentHolder);*/
			TweenMax.to (contentHolder, .25, {alpha:1, visible:true, ease:Sine.easeOut});
			errorState = true;
		}
		...
		private function removeFromDisplay():void{
			/*if (placementTarget.contains(contentHolder)){*/
				...
				TweenMax.to (contentHolder, .75, {alpha:0, visible:false, ease:Sine.easeOut});
				errorState = false;
			/*}*/
		}
	}
